...
const SecretaryModal = ({ isOpen, onClose }) => {
    ...
    <div className="w-72 h-96">
      ...
      />
        ...
        <div className="text-center px-12 py-3">
          <h4 className="text-2xl font-bold text-blue-700">ER. AJAY ARJUNRAO PATIL</h4>
          <p className="text-lg text-blue-600 font-semibold">Chairman, IEI Chh. Sambhajinagar</p>
        </div>

        {/* Biography */}
        <div className="px-12 py-6 text-gray-700">
          <p className="text-base leading-relaxed text-justify mb-4">
            ER. AJAY ARJUNRAO PATIL serves as the Chairman of The Institution of Engineers (India), Chh. Sambhajinagar Chapter. With extensive administrative and technical expertise, he oversees the day-to-day operations and strategic initiatives of the chapter, ensuring its commitment to engineering excellence and professional development.
          </p>

          <h5 className="text-base font-bold text-blue-700 mb-3">ACADEMIC AND PROFESSIONAL BACKGROUND</h5>
          <p className="text-base leading-relaxed text-justify mb-4">
            MEMBERSHIP GRADE & ENGINEERING DIVISION: FIE NO.131763-2 (MECHANICAL ENGINEERING DIVISION)
          </p>
          <p className="text-base leading-relaxed text-justify">
            PRESENT PROFESSIONAL POSITION: CHAIRMAN, SHRI CHHATRAPATI RAJASHRI SHAHU URBAN CO-OPERATIVE BANK LTD. BEED-431122
          </p>
        </div>
